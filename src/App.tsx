...
function App() {
    ...
    return (
        <div className="w-full h-full scroll-smooth overflow-auto flex flex-col min-w-0 min-h-0 p-4">
            <Input
                id="search_bar"
            ...
            />
            <div className="w-full h-[85%] whitespace-wrap max-w-full flex flex-col mt-2">
